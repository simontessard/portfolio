export const projects = [
  {
    ...
    explication1:
      "La phase 2 est toujours en phase de conception, mais la banque souhaite avoir des propositions d'API proposées pour les transactions. Il est demandé de fournir un document décrivant les API proposées pour les transactions, en suivant les directives de Swagger. Le document doit contenir des informations telles que la méthode HTTP, la route, la description de ce à quoi correspond l'endpoint, les paramètres possibles et les différentes réponses avec les codes de réponse correspondants qui ont un sens pour cet endpoint. Il est possible d'utiliser la page des transactions présentée dans les maquettes pour guider les choix. Une revue de code et une discussion sur la proposition d'API seront effectuées une fois que tout sera terminé.",
    explication2:
      "La phase 2 est toujours en phase de conception, mais la banque souhaite avoir des propositions d'API proposées pour les transactions. Il est demandé de fournir un document décrivant les API proposées pour les transactions, en suivant les directives de Swagger. Le document doit contenir des informations telles que la méthode HTTP, la route, la description de ce à quoi correspond l'endpoint, les paramètres possibles et les différentes réponses avec les codes de réponse correspondants qui ont un sens pour cet endpoint. Il est possible d'utiliser la page des transactions présentée dans les maquettes pour guider les choix. Une revue de code et une discussion sur la proposition d'API seront effectuées une fois que tout sera terminé.",
